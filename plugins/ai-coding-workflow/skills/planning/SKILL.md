...
2. **讀取參考文件**：
   - `references/overview.md` - 規劃總覽
   - `references/task-decomposition.md` - 任務拆解方法
...
| 規劃類型 | 參考文件                             |
| -------- | ------------------------------------ |
| 需求分析 | `references/requirement-analysis.md` |
| 技術選型 | `references/tech-stack-selection.md` |
| 架構設計 | `references/architecture-design.md`  |
| 任務拆解 | `references/task-decomposition.md`   |

### Prompts 目錄

- `references/prompts/analyze-requirements.md` - 需求分析
- `references/prompts/create-plan.md` - 計畫建立
...
| 場景       | 讀取                    | 執行                            |
| ---------- | ----------------------- | ------------------------------- |
| 新專案規劃 | overview.md             | prompts/analyze-requirements.md |
| 技術選型   | tech-stack-selection.md | prompts/create-plan.md          |
| 架構設計   | architecture-design.md  | prompts/create-plan.md          |
| 任務拆解   | task-decomposition.md   | prompts/create-plan.md          |
