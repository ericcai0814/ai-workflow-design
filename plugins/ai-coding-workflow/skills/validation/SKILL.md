...
2. **讀取參考文件**：
   - `references/validation-framework.md` - 三層驗證框架（關鍵）
   - `references/testing.md` - 測試策略
...
| 驗證任務 | 參考文件                             |
| -------- | ------------------------------------ |
| 驗證框架 | `references/validation-framework.md` |
| 整合測試 | `references/integration.md`          |
| 測試策略 | `references/testing.md`              |

### Prompts 目錄

- `references/prompts/integration-test.md` - 整合測試
- `references/prompts/feature-implementation.md` - 功能實作（含測試）
...
| 場景     | 讀取                    | 執行                              |
| -------- | ----------------------- | --------------------------------- |
| 建立測試 | testing.md              | prompts/integration-test.md       |
| 驗證框架 | validation-framework.md | prompts/feature-implementation.md |
| 整合測試 | integration.md          | prompts/integration-test.md       |
